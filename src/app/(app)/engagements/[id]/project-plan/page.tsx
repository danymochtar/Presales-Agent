...
export default async function ProjectPlanPage({
  ...
  const versionsForCloud = plans.filter((d) => {
  ...
  return (
    <DeliverableWorkspace
      ...
      generatePath={`/api/engagements/${project.id}/project-plan/generate?cloud=${activeCloud}`}
      canGenerate={true}
      ...
      basePath={`/engagements/${project.id}/project-plan`}
    />
  );
}
