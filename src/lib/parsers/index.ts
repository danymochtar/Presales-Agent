...
export async function parseDocument(
  ...
  // Excel: try Azure Migrate format, then RVTools, fall through to other.
  if (XLSX_EXT.includes(e)) {
    ...
    warnings.push("Excel sheet did not match RVTools or Azure Migrate format");
    return { kind: "generic_csv", filename, contentType, rawSummary: `Spreadsheet uploaded but not auto-parsed`, truncated: false, warnings };
  }
